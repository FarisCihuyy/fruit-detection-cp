...
export default async function Page({ params }: Props) {
  ...
  return (
    <main className="space-y-12 md:mt-8 min-h-screen md:max-w-2xl lg:max-w-3xl mx-auto">
